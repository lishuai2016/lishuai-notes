...
public class HttpTool {
    ...
    public static void main(String[] args) {
        //uploadFile
        //uploadFile(new File("d:/ljj.txt"),"http://storage.jd.com/ads-dxp-online/lishuai/baidu/test/ljj.txt?Expires=1547542380&AccessKey=qEJVmIGO085v0Pgu&Signature=9b9vqq3lU8tNr38guvw6lTmrMNw%3D");

        uploadFile(new File("d:/lishuai.txt"), "http://storage.jd.com/ads-dxp-online/ls/lishuai.txt?Expires=1554200475&AccessKey=qEJVmIGO085v0Pgu&Signature=RAZmi7k6IlhB8a7RWTKlnR3qa1M%3D");
    }
